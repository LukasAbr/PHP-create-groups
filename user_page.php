...
<html>
    ...
    <body>
         <div id="Topbar">
            ...
            <ul>
                <li>
                    <form action="create_group_user.php" >
       ...
       <div class="container">
             <header class="major">
                <h2><span id="siteTitle">Sveiki- <?php echo $_SESSION['username'] ?> </span></h2>
                <p><span id="siteDiscription">Raskite sau tinkamiausia grupę!</span></p>
            </header>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="#">
                        <button  id="orderByNewest" >Newest</button>
                        <button  id="orderByOldest" >Oldest</button>
                    </a>

                    <a href="#">
                        <p style="margin:0"> Date: <input type="date" style="color: black"></input></p>
                    </a>
